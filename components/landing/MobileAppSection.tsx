        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-100 border border-orange-200 mb-6">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-orange-700">Mobile Experience</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight text-slate-900">Healthcare in Your Pocket</h2>
          ...
          <div className="relative flex justify-center py-10">
            ...
            <div className="absolute top-[15%] right-[5%] lg:right-[20%] bg-white/90 backdrop-blur-xl p-4 rounded-2xl shadow-2xl border border-white/20 animate-float-delayed z-20 hidden md:block">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-900">New Job Match</p>
                  <p className="text-xs text-slate-500">Senior Nurse • Apollo Hospitals</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-[20%] left-[5%] lg:left-[20%] bg-white/90 backdrop-blur-xl p-4 rounded-2xl shadow-2xl border border-white/20 animate-float z-20 hidden md:block">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-900">Application Sent</p>
                  <p className="text-xs text-slate-500">Successfully applied to 3 roles</p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-6 relative z-30">
            ...
            >
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-[10px] uppercase font-bold tracking-widest text-slate-400">Get it on</span>
                <span className="text-[22px] font-semibold -mt-1 tracking-tight">Google Play</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-[10px] font-bold text-slate-500">Download on the</span>
                <span className="text-[22px] font-semibold -mt-1 tracking-tight">App Store</span>
              </div>
            </a>
          </div>
        </div>
