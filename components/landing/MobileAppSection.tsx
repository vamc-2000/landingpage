...
>>>>>>> 455670bf7adb3806ded0669c2b855cca27294f0d
...
=======
        <div className="relative flex flex-col items-center justify-center py-10 w-full max-w-4xl mx-auto">
          {/* Main App Image Slider */}
          <div className="relative z-10 w-full max-w-[280px] sm:max-w-[360px] aspect-[418/941] flex justify-center drop-shadow-2xl mb-12">
            <AnimatePresence mode="wait">
              ...
              >
                <Image
                  ...
                  alt={`RBC24 App Interface Slide ${currentIndex + 1}`}
                  fill
...
>>>>>>> 455670bf7adb3806ded0669c2b855cca27294f0d
            ...
            <div className="absolute inset-0 bg-orange-400/20 blur-[100px] -z-10 rounded-[3rem]" />
          </div>

          {/* Action Buttons */}
          <div className="flex flex-col items-center gap-6 z-30">
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#1e3a8a] tracking-tight text-center">
              Available on
            </h3>
