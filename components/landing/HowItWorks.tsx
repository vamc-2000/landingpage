    ...
    <section id="how-it-works" className="relative pb-24 pt-0 lg:pb-32 lg:pt-0 bg-[#FAFAF8] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20 animate-slide-up">
          <h2 className="text-section mb-6 tracking-tight">The Modern Healthcare Workflow</h2>
                  ...
                  {flow.steps.map((step, sIdx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        */}
                        <div className={`
                          bg-white rounded-[2rem] p-8 w-full border border-black/5 shadow-[0_4px_20px_rgba(0,0,0,0.03)]
